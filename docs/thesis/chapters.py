...
def _unanswered(data: dict) -> str:
    ...
    burimin, dhe atëherë verdikti është vetëm «u parsua» (VD-136). Ato nuk janë
...
def _overturned_case() -> str:
    ...
    # Që nga VD-135 rreshti mban edhe gabimet që rishkrimi shtoi brenda projektit.
...
def _project_of(file_path: str) -> str:
    ...
    Shtegu është relativ ndaj rrënjës së korpusit që nga VD-135, ndaj dosja e
...
def _unchecked_sentence(unchecked: int) -> str:
    ...
    Kjo fjali i atribuohej vetëm kufirit kohor. Që nga VD-136 një `javac` që
