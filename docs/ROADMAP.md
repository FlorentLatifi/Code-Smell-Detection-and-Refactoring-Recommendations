...
| Testet | ✅ 575 kalojnë, mbulim 95% | vlera të derivuara me dorë; 1 anashkalohet pa symlink. Kufiri i VD-64, asnjë modul nën 90%, ka rënë pak: `cli.py` dhe `refactor/apply.py` janë te 89%, `__main__.py` (2 rreshta) pa test (VD-121) |
