...
| Testet | ✅ 505 kalojnë, mbulim 95% | vlera të derivuara me dorë; asnjë modul nën 90% (VD-64); 1 anashkalohet pa symlink |
...
| Frontend | ✅ e plotë | React + TypeScript + Vite; panel me Tailwind, Recharts dhe lucide (VD-106); dy pamje; të dy qasjet përballë njëra-tjetrës (VD-48); 112 teste me vitest plus 9 end-to-end, nga të cilat 4 me axe mbi shfletues (VD-87, VD-108); auditim i plotë (VD-85, VD-86); lista grupuar sipas vendit (VD-68) |
