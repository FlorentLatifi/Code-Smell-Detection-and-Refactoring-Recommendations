...
| Testet | ✅ 591 kalojnë, mbulim 96% | vlera të derivuara me dorë; 1 anashkalohet pa symlink; asnjë modul nën 90% (VD-64), kufi i rikthyer me testet e `--apply` dhe të dështimeve të `git`-it (VD-123) |
...
| Frontend | ✅ e plotë | React + TypeScript + Vite; panel me Tailwind, Recharts dhe lucide (VD-106); një paletë, fonte lokale dhe matësi i klauzolës (VD-119); dy pamje; të dy qasjet përballë njëra-tjetrës (VD-48); 146 teste me vitest plus 9 end-to-end, nga të cilat 4 me axe mbi shfletues (VD-87, VD-108); erërat para dhe pas shkrimit, dhe grafiku i ngarkuar kur duhet (VD-123); auditim i plotë (VD-85, VD-86); lista grupuar sipas vendit (VD-68) |
