...
| Frontend | ✅ e plotë | React + TypeScript + Vite; dy pamje; të dy qasjet përballë njëra-tjetrës (VD-48); 79 teste me vitest plus 5 end-to-end (VD-87); auditim i plotë (VD-85, VD-86); lista grupuar sipas vendit (VD-68) |
