...
| Frontend | ✅ e plotë | React + TypeScript + Vite; dy pamje; të dy qasjet përballë njëra-tjetrës (VD-48); 39 teste me vitest (VD-54, VD-65); lista grupuar sipas vendit (VD-68) |
