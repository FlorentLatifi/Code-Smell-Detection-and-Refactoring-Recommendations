...
test("analizon një projekt dhe hap kodin e një gjetjeje", async ({ page }) => {
  ...
  // Shifrat vijnë nga serveri, jo nga ndërfaqja. Shiriti i statusit i mban:
  // fikstuarat janë dy skedarë, të fiksuara nga testet e backend-it.
  ...
  await expect(page.getByRole("img", { name: /erëra gjithsej/ })).toBeVisible();
